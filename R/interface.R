...
start_package <- function(){
  ...
  n <- as.integer(readline(prompt = "To learn how to load and view your data, Type 2 and press enter to continue \nIf you would like to learn how to select particular columns and rows, type 2 and press enter to continue"))
  if(n == 1){
    load_dplyr()
  }
  else{
